...
function SectionHeading({
  ...
  return (
    <div className="flex gap-4">
      <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-violet-100 text-violet-700 text-sm font-bold">
        {number}
      </div>
      <div>
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        {/* Info banner */}
        <div className="bg-violet-50 border-b border-violet-100 px-6 py-3 flex items-center gap-2">
          <svg className="h-4 w-4 text-violet-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
        ...
        {/* Sticky footer */}
        <div className="sticky bottom-0 bg-white border-t border-slate-200 px-6 sm:px-8 py-4">
          {/* Error message */}
          {error && (
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2 text-xs text-slate-500">
              ...
              Saved as a draft when you click Save Draft.
            </div>
